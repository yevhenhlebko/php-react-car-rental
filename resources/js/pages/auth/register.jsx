    ...
    <>
      ...
      <div className="flex justify-center items-center w-full flex-col py-4 min-h-screen bg-black">
        <div className="p-8 flex flex-col items-center">
          <div className="text-6xl leading-loose text-white font-bungee font-bold">AJ’s Experience</div>
        </div>
          ...
          <form onSubmit={handleSubmit} method="POST">
            <div className="mb-4 mt-2">
              ...
              <input
                ...
                id="username"
                name="name"
                className={`appearance-none border rounded w-full py-1 px-3 bg-gray-100 ${
